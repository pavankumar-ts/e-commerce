...
function MainLogin() {
  ...
  const setOpenPhoneNo = useContext(phoneNoLogin)
  //
  const One = () => (
  ...
  return (
    <div className='loginWrap'>
      ...
      <div className="loginOp">
        <div className="login" id="phone" onClick={()=> setOpenPhoneNo(true)} >
          <div className="icon"  >
            <BsPhone />
          </div>
          Continue with Phone
        </div>
        <div className="login" id="faceBook" onClick={() => alert("Facebook Authenticate not available")}>
          <div className="icon">
            <BsFacebook />
          </div>
